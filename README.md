A privacy-preserving heart-rate monitoring system using Paillier Homomorphic Encryption (PHE).
The smartwatch collects BPM data, encrypts it at the edge, sends ciphertext to a secure server, performs homomorphic aggregation, and triggers alerts after decryption.
...
3. Run the decryptor module
python decryptor/decrypt.py

4. Run the edge module to send encrypted heart-rate readings
python edge/send_data.py
